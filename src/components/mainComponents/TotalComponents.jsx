...
export default class TotalComponents extends React.Component {
  ...
  handleClick() {
    this.setState({
      openSales: !this.state.openSales,
      openIncome: !this.state.openIncome,
  ...
  render(){
    ...
    <div className="totalComponent row col-12 justify-content-between m-0 mb-5 p-0" >
            <div className={ this.openSales? "opened":"totalCard d-flex  justify-content-center mt-5 p-5 p-md-0"}
           >
